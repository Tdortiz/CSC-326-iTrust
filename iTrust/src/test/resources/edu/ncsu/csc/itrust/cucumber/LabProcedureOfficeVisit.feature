...
And I add a new prescription with the following information: Medication: 08109-6 Aspirin, Dosage: 75, Dates: 2016-11-15 to 2017-11-14, Instructions: Number Per day: 1;(cr)Not sure why patient's heart-rate was elevated? Re-evaluate in a year.
...
And After the office visit has been created, its prescription info is: drugname: Aspirin, Code: 08109-6, Dosage: 75, Start Date: 2016-11-15, End Date: 2017-11-14, Special instructions: Number Per day: 1;(cr)Not sure why patient's heart-rate was elevated? Re-evaluate in a year.
...
Given I load uc11.sql
When I add a new prescription with the following information: Medication: 64764-1512 Aspirin, Dosage: 100, Dates: 2016-11-28 to 2015-11-05, Instructions: take with a lot of water
Then None should be on record
