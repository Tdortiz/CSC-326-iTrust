...
And Examine the report for Patient 201
Then name: "Sandy Sky", age: "24" gender: "Male", emergency contact: "Susan Sky-Walker 444-332-4309", allergies: "Pollen, 05/05/2016 and Penicillin, 06/04/2016", blood type: "O-", diagnoses: ICD10 J45 (Asthma), and 00 (Acute Nasopharyngitis), prescriptions: 483013420 (Midichlomaxene), and NDC 63739291 (Oyster Shell Calcium with Vitamin D), immunizaitons: CPT 90715 (TDAP)
...
When I login as 9000000006 using pw
And Go to the Emergency Patient Report.
And Examine the report for Patient 202
Then name: "Sarah Sky-Walker", gender: "Female", emergency contact: "Susan Sky-Walker 444-332-4309", no allergies, blood type: "O+", diagnosis: 00 (Acute Nasopharyngitis), prescriptions: NDC 63739291 (Oyster Shell Calcium with Vitamin D), no immunizations
...
When I login as 9000000006 using pw
And Go to the Emergency Patient Report.
And Examine the report for Patient 2002
...
When I login as 9000000000 using pw
And Go to the Emergency Patient Report.
And Examine the report for Patient 203
